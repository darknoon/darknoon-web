...
If you do a lot of graphics development, you're sure to use lots of vector math.

Say you have a simple numerical solver that keeps track of the position of a ball over time written in C. You might have some code that looks like this:
...
So, if you don't mind switching to c++, you can make your vector math a lot simpler to process. If you notice anything wrong with the file or anything you think should be added, please create an issue or send a pull request "on github":https://github.com/darknoon/GLKitMathCPP
