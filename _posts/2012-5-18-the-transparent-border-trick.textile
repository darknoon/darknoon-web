...
p(center). !/images/transparent-border-trick/zoomed.png!
...
p(center). !/images/transparent-border-trick/content.png!
...
h3. Wouldn't it be better if we just antialiased all CoreAnimation content?
...
So, uh, what's "bi-linear filtering":http://en.wikipedia.org/wiki/Bilinear_filtering ?
