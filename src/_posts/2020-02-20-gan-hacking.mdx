...
We're going to use [Andy Brock's PyTorch port of BigGAN](https://github.com/ajbrock/BigGAN-PyTorch), which contains code to convert the original weights from TFHub (google's storage) into the right format for PyTorch.
...
Comparing [original](https://artbreeder.com/i?k=83b5f5830c1ad242c50d):

![Original abstract artbreeder image](images/gan-hacking/artbreeder/83b5f5830c1ad242c50d.jpg)

To PyTorch version:

![Original abstract artbreeder image](images/gan-hacking/artbreeder/83b5f5830c1ad242c50d-pytorch.jpg)
...
![Image of images with artbreeder](images/gan-hacking/artbreeder/image-of-images-ce835203d6b54e8f2d82.jpg)
